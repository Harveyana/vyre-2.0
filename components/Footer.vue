<template>
    <footer class="max-w-screen-xl px-8 mx-auto">
        ...
        <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
          ...
          >
            <div class="sm:hidden xl:block mb-6 sm:mb-0">
              <a href="#">
                <img src='~/assets/img/logo/vyreLogo3.png' class="w-24 -mt-2" alt="Vyre Logo" />
              </a>
            </div>
            <ul class="space-y-4">
              <NavLink name="Banking" url="/banking" />
              <NavLink name="Swap" url="/swap" />
              <NavLink name="Payment" url="/payments" />
              <NavLink name="User" url="#" />
              <NavLink name="Faq" url="/faqs" />
            </ul>
          </div>
          <div
          ...
          >
            <h5 class="text-sm font-medium text-[#666666] focus:outline-none focus:shadow-outline"> Join our Vyre Newsletter</h5>
      ...
      <div class="py-8 sm:py-4 text-center text-sm text-[#666666] hover:text-gray-900">
        &copy; Copyright 2023 VYRE AFRICA. All rights reserved
      </div>
    </footer>
  </template>
  <script>
