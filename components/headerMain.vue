<template>
        ...
        <div class="bg-[#F2F4F5] border-b border-gray-200 dark:bg-[#0B1015] dark:border-gray-700 rounded-2xl">
          ...
          <div class="px-3 py-1 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
              <h1 class="hidden sm:flex Grotesque-Bold dark:text-white text-xl text-[#010109]">
                {{$router.currentRoute.value.name == 'index'? 'Home': $router.currentRoute.value.name}}
              </h1>
              <div class="flex items-center justify-start">
                
                <button @click="$emit('toggle')" id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar" class="p-2 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
              ...
              <div class="flex items-center">
                  ...
                  <!-- Dropdown menu -->
                  <div v-if="showNotification" class="absolute top-14 right-4 z-20 z-50 max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                    ...
                    <div>
                      <a href="#" class=" flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                        <div class="flex-shrink-0">
                          <img class="rounded-full w-11 h-11" src="~/assets/img/users/bonnie-green.png" alt="Jese image">
                      ...
                      <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                        <div class="flex-shrink-0">
                          <img class="rounded-full w-11 h-11" src="~/assets/img/users/jese-leos.png" alt="Jese image">
                      ...
                      <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                        <div class="flex-shrink-0">
                          <img class="rounded-full w-11 h-11" src="~/assets/img/users/joseph-mcfall.png" alt="Joseph image">
                      ...
                      <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                        <div class="flex-shrink-0">
                          <img class="rounded-full w-11 h-11" src="~/assets/img/users/leslie-livingston.png" alt="Leslie image">
                      ...
                      <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                        <div class="flex-shrink-0">
                          <img class="rounded-full w-11 h-11" src="~/assets/img/users/robert-brown.png" alt="Robert image">
                  ...
                  <button @click="toggleDark()" id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                    <svg v-if="isDark" id="theme-toggle-dark-icon" class=" w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
                  ...
                  <div class="flex items-center ml-3">
                    <div>
                      <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                        ...
                        <img v-if="user && user?.photoUrl" class="w-8 h-8 rounded-full" :src="user?.photoUrl" alt="user photo">
                      </button>
                    </div>
                    <!-- Dropdown menu -->
  ...
  <script setup lang="ts">
   ...
   function getItem(item:string) {
    ...
    // const darkMode = ref(getItem('darkMode') == 'true') ? true : false)

  //  const mode = ref(getItem('color-theme') ?? 'light')
    // const mode = computed(() => getItem('color-theme'))
      ...
      // if (mode.value === 'dark' && window.matchMedia('(prefers-color-scheme: dark)').matches) {
