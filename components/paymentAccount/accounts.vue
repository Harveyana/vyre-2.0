        ...
        <div v-else class="w-full flex flex-col items-center justify-center rounded-2xl gap-y-3">
          ...
          <div class="w-full">
            ...
            <div class="flex flex-col w-full h-full gap-y-6 my-4">
              ...
              <div
                class="w-full border border-dashed hover:border-black flex items-center justify-center gap-x-5 py-4 bg-white rounded-lg border-[1px] px-4 cursor-pointer"
              >
                
                <button @click="LinkAccount()" class="flex justify-center items-center gap-3">
              ...
              >
                ...
                <h2 v-if="account?.currency" class="border rounded-full bg-black text-white text-[14px] px-2 py-3 ">
                  {{ account?.currency }}
                </h2>

                <div class="flex flex-col justify-start items-start">
                  <h3 v-if="account?.bank" class="Grotesque-Regular text-[14px] text-[#1A1A1A]">
                    {{account?.bank}}
                  </h3>
