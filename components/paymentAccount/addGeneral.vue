    ...
    <div class="w-full h-fit flex flex-col items-center justify-start gap-3 rounded-lg overflow-y-auto pt-8">
      ...
      <div v-if="SELECT === 'START'" class="w-full h-fit flex flex-col items-center justify-center gap-3 rounded-3xl shadow-md px-2 pt-4 sm:pt-6 pb-4">
        ...
        <div class="flex flex-col items-center justify-center gap-y-4">
          ...
          <button @click="SELECT = 'ACCOUNTS'" class="w-full rainbow-border-box flex flex-col items-center justify-center gap-y-2 rounded-2xl p-[5px]  bg-black">
      ...
      <div v-if="SELECT === 'ACCOUNTS'" class="w-full h-fit flex flex-col items-center justify-start gap-3 rounded-3xl shadow-md px-2 pt-4 sm:pt-6 pb-4">
