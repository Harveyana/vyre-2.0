    ...
    <div class="flex items-center justify-center gap-2 bg-white p-2 rounded-3xl">
      <div class="hidden sm:flex items-center justify-center rounded-3xl bg-black px-6 py-2">
          <ul class="flex items-center justify-center gap-4">
            ...
            <li>
                <NuxtLink href="" :class="$route.path == '/receive'? 'text-black bg-white':'text-white bg-black hover:bg-white'"  class="flex items-center justify-center gap-1 py-2 px-3 text-base text-gray-900 rounded-full  group">
