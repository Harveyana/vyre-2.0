<template>
   ...
   <div class="w-[99%] fixed bottom-2 left-[1px] flex sm:hidden items-center justify-center rounded-3xl bg-black px-4 py-2">
                  <ul class="flex items-center justify-between gap-2">
                     ...
                     <li>
                        <NuxtLink href="" :class="$route.path == '/send'? 'text-black bg-white':'text-white bg-black hover:bg-white'"  class="flex items-center justify-center gap-1 py-2 px-3 text-base text-gray-900 rounded-full  group">
                           <svg xmlns="http://www.w3.org/2000/svg" :class="$route.path == '/send'? 'text-black':'text-gray-500'" class="flex-shrink-0 w-6 h-6  transition duration-75 group-hover:text-black" viewBox="0 0 24 24"><path fill="currentColor" d="M20.04 2.323c1.016-.355 1.992.621 1.637 1.637l-5.925 16.93c-.385 1.098-1.915 1.16-2.387.097l-2.859-6.432l4.024-4.025a.75.75 0 0 0-1.06-1.06l-4.025 4.024l-6.432-2.859c-1.063-.473-1-2.002.097-2.387z"/></svg>
                     ...
                     <!-- <button type="button" class="flex items-center justify-center w-fit text-sm bg-black rounded-full focus:ring-0 " id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                     ...
                     <!-- <svg xmlns="http://www.w3.org/2000/svg" class="mx-2" width="16" height="16" viewBox="0 0 24 24"><path fill="#ffff" d="M11.178 19.569a.998.998 0 0 0 1.644 0l9-13A.999.999 0 0 0 21 5H3a1.002 1.002 0 0 0-.822 1.569z"/></svg> -->
