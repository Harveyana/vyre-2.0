    ...
    <div class="w-full relative py-3 gap-y-4 flex flex-row items-center justify-center">
      ...
      <div class="w-full sm:w-[55%] sm:py-12 p-4 sm:px-10 gap-y-6 flex flex-col items-center justify-between rounded-lg border border-[#F4F4FB]">
        ...
        <div class="w-full flex flex-col items-star justify-center gap-y-1">
          ...
          <input id="place" @input="" v-model="receiver.location" placeholder="enter location" class="w-full bg-[#F9F9FC] rounded-lg text-[12px] border border-gray-300 px-3 py-3 text-gray-800 outline-black"></input>
        </div>
        ...
        <div class="w-full flex flex-col items-star justify-center gap-y-1">
          ...
          <input  @input="" v-model="receiver.name" placeholder="enter name" class="w-full bg-[#F9F9FC] rounded-lg text-[12px] border border-gray-300 px-3 py-3 text-gray-800 outline-black"></input>
        </div>
        ...
        <div class="w-full flex flex-col items-star justify-center gap-y-1">
          ...
          <input  @input="" v-model="receiver.phoneNumber" placeholder="+234" class="w-full bg-[#F9F9FC] rounded-lg border border-gray-300 text-[12px] px-3 py-3 text-gray-800 outline-black"></input>
        </div>
        ...
        <div class="w-full flex flex-row items-center justify-start">
          ...
          <div v-else class="w-full flex flex-col items-start justify-center gap-y-1">
            ...
            <input @input="" v-model="receiver.additional_Number" placeholder="+234" class="w-full bg-[#F9F9FC] rounded-lg border border-gray-300 px-3 py-3 text-[12px] text-gray-800 outline-black"></input>
          </div>
