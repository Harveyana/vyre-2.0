        ...
        <div class="w-full lg:w-[80%] flex flex-col items-start justify-center space-y-4">
          ...
          <div class="w-full flex flex-col items-start justify-start space-y-4">
            ...
            <!-- <div class="w-full flex flex-col items-start "> -->
              <button :disabled="!isValidForm" @click.prevent="submitForm" :class="{ 'bg-[#34da97]': isValidForm }" class="w-full bg-[#89ead9] flex flex-row items-center justify-center rounded-3xl py-2">
                <span v-if="!showLoader" class="text-[14px] text-black hover:text-gray-200 text-center">Login</span>
