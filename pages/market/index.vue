<template>
  ...
  <div class="bg-gray-50 h-[80vh] rounded-2xl w-full gap-x-1 lg:gap-x-6 ">
      ...
      <div class="w-full sm:w-[65%] flex flex-col gap-4 ">
        ...
        <div class="w-full flex items-center justify-between">
          ...
          <div class="flex items-center justify-center gap-2">
            ...
            <NuxtLink href="/market/createOrder" class="flex items-center bg-gray-200 rounded-xl Grotesque-Bold w-fit py-2 px-4 text-black text-[14px]">
    ...
    <BaseDialogue :visible="showCreateModal" class="bg-white">

      <div class="relative flex flex-col lg:w-[350px] gap-y-2 bg-white">
